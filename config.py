...
prob_crossover_global = 0.6  # global probability for cx
prob_crossover_individual_cond = 0.9  # probability to cx a specific cond tree in an individual
prob_crossover_individual_val = 0.9  # probability to cx a specific cond tree in an individual
